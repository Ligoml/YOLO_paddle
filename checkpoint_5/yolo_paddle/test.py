...
parser.add_argument('-size', '--input_size', default=416, type=int,
                    help='input_size')
parser.add_argument('--trained_model', default='./weights/voc/yolo/yolo_best_model.pdparams',
...
def test(net, device, testset, transform, thresh, class_colors=None, class_names=None, class_indexs=None, dataset='voc'):
    ...
    for index in range(num_images):
        ...
        print('./test_images/' + args.dataset+ '/' + str(index).zfill(6) +'.jpg')
...
if __name__ == '__main__':
    ...
    if args.dataset == 'voc':
        ...
        class_indexs = None
        num_classes = 20
        dataset = VOCDetection(root="../../../VOCdevkit/", img_size=input_size[0], image_sets=[('2007', 'test')], transform=None)
